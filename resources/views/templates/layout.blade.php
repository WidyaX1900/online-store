    ...
    <nav class="d-flex">
        <div class="navigation d-flex justify-content-between align-items-center">
            ...
            <div class="logout-container d-flex justify-content-between align-items-center">
                ...
                <a href="/logout" style="font-size: 1.5rem; text-decoration: none;" class="text-light">
                    Logout
                </a>
            </div>
        </div>
...
<script src="{{ config('app.url').'/online-store/resources/js/product-cta.js' }}"></script>
<script src="{{ config('app.url').'/online-store/resources/js/info-amount.js' }}"></script>
</html>